...
```
**Para que sirve:** Filtrar líneas por patrón.
...
```
**Para que sirve:** Ordenar líneas (necesario antes de uniq).
...
```
**Para que sirve:** Eliminar o contar líneas duplicadas.
...
```
**Para que sirve:** Contar líneas, palabras o bytes.
